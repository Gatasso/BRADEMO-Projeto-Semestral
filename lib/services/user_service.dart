...
class UserService {
  ...
  static Future<void> logout(BuildContext context) async {
    // Dispara a limpeza reativa do estado global do Provider
    await context.read<UserProvider>().efetuarLogout();

    // Garante a limpeza da box utilitária de autenticação secundária se necessário
    final authBox = Hive.box('authBox');
    await authBox.clear();
  }
}
